@include('partials.header')
                ...
                <div class="flex justify-between max-lg:flex-col gap-y-10">
                    ...
                    <div class="right lg:w-1/4 lg:pl-4">
                        <div class="item">
                            ...
                            <p class="mt-3">SHOP No: 121-0, Hairs Mohd Building, Al Ras, Dubai, U.A.E</p>
                            <p class="mt-3">Phone: <span class="whitespace-nowrap">+971 50 923 8325</span></p>
                            <p class="mt-1">Email: <span class="whitespace-nowrap">dairybestfood@gmail.com</span></p>
                        </div>
        ...
        <div class="map xl:h-[600px] sm:h-[500px] h-[450px] overflow-hidden">
            <iframe class="w-full h-full" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3608.070624026597!2d55.293009075384134!3d25.268209577665292!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f439a1582980b%3A0x6e817efe116b19c6!2sDairy%20Best%20Foodstuff%20Trading%20LLC!5e0!3m2!1sen!2sae!4v1746282979769!5m2!1sen!2sae" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
