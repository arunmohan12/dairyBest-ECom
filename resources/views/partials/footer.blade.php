<div id="footer" class="footer">
            ...
            <div class="container">
                <div class="content-footer md:py-[60px] py-10 flex justify-between flex-wrap gap-y-8">
                    <div class="company-infor basis-1/4 max-lg:basis-full pr-7">
                        <a href="index.html" class="logo text-3xl font-semibold text-center flex items-center gap-2">
                            <img src="{{ asset('assets/images/home/logo.png')}}" alt="Dairy Best" class="logo-footer">
                        ...
                        <div class="flex gap-3 mt-3">
                            ...
                            <div class="flex flex-col">
                                <span class="">dairybestfood@gmail.com</span>
                                <span class="mt-[14px]">+971 50 923 8325</span>
                                <span class="mt-3 pt-1">SHOP No: 121-0, Hairs Mohd Building, Al Ras, Dubai, U.A.E</span>
                            </div>
                        </div>
                    </div>
                    <div class="right-content flex flex-wrap gap-y-8 basis-3/4 max-lg:basis-full">
                        <div class="list-nav flex justify-between basis-2/3 max-md:basis-full gap-4">
                            ...
                            <div class="item flex flex-col basis-1/3">
                                ...
                                <a class="caption1 has-line-before duration-300 w-fit" href="javascript:void(0)">La-Mira Pistachio Chocolate</a>
                                <a class="caption1 has-line-before duration-300 w-fit pt-2" href="javascript:void(0)">Chocolate Hazlenut Cream </a>
                                <a class="caption1 has-line-before duration-300 w-fit pt-2" href="javascript:void(0)">Tostato Coffee </a>
                                <a class="caption1 has-line-before duration-300 w-fit pt-2" href="javascript:void(0)"> Milk Choco </a>
                ...
                <div class="footer-bottom py-3 flex items-center justify-between gap-5 max-lg:justify-center max-lg:flex-col border-t border-line">
                    <div class="left flex items-center gap-8">
                        <div class="copyright caption1 text-secondary">©2025 Scilens Media. All Rights Reserved.</div>
    ...
    <script src="{{ asset('assets/js/scilens.js')}}"></script>
